CREATE TABLE [dbo].[Staging_Stock_Packs]
(
[ID] [bigint] NOT NULL,
...
GO
ALTER TABLE [dbo].[Staging_Stock_Packs] ADD CONSTRAINT [PK_Staging_Stock_Packs] PRIMARY KEY CLUSTERED  ([ID], [SiteID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
