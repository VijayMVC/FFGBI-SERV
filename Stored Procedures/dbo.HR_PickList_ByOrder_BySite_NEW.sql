...
-- exec [dbo].[HR_PickList_ByOrder_BySite_NEW] 132107,4,0,0


CREATE PROCEDURE [dbo].[HR_PickList_ByOrder_BySite_NEW] 
@OrderNo Int,
@SiteID int,
@Addon int,
@Sawyers int
...
BEGIN
	...
	Order By VIP,Description3,[Name],
	HR_Boxno,ProductCode, USEBY, DNOB
