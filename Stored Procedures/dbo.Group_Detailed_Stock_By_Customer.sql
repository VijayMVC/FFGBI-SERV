...
-- Description:	Group stock filter by customer
-- =============================================
CREATE PROCEDURE [dbo].[Group_Detailed_Stock_By_Customer] 
	-- Add the parameters for the stored procedure here
 @_Customer nvarchar (50) 
AS
BEGIN
...
WHERE  
con.[name] = @_Customer and mat1.storageType = 1 and pr.InventoryTypeID = 1 and not(pr.description1 like '%FROZEN%')
