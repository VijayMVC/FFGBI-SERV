...
-- Description:	Create a Confimed scanned to order report
-- =============================================
--exec HR_Confirmed_Scanned_toOrder_Report 105423
CREATE PROCEDURE [dbo].[HR_Confirmed_Scanned_toOrder_Report] 
