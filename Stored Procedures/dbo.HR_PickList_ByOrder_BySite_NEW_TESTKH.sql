...
-- [dbo].[HR_PickList_ByOrder_BySite_NEW_TESTKH]  128663,5,0,0


CREATE PROCEDURE [dbo].[HR_PickList_ByOrder_BySite_NEW_TESTKH] 
@OrderNo Int,
@SiteID int,
@Addon int,
@Sawyers int
...
BEGIN
	...
	group by pal.palletnumber, OA.DNOB, OA.USEBY,OA.SiteID,PalletNo,OA.OrderNo,OA.SubOrderNo,OA.Modified,OS.Modified,OS.Sub_Order_no,OA.OrderDate, OA.ProductCode,OA.InProductionStock,OA.HR_BoxNo,OA.PalletID,
			 ...
			 INV.[Name], INVL.Code, INV.description3,pk.prday ,oa.boxno
