...
-- Description:	Fresh report by site and by Customer
-- =============================================
CREATE PROCEDURE [dbo].[Fresh_Report_By_Site_And_Customer] 
	-- Add the parameters for the stored procedure here


@_site int,
@_Customer nvarchar (200) 
AS
BEGIN
...
mat1.storageType = 1 and pr.InventoryTypeID = 1 and not(pr.description1 like '%FROZEN%')
 and pk.siteid = @_site and con.name = @_Customer 
