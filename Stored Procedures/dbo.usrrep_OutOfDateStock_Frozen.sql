...
-- =============================================
CREATE PROCEDURE [dbo].[usrrep_OutOfDateStock_Frozen]

--exec [dbo].[usrrep_OutOfDateStock_Frozen]
...
where pk.UseBy <= GETDATE() and (pr.description1 like '%FROZEN%')   and pk.[weight] > 0.1 and pk.ProductCode <> '999999999'
