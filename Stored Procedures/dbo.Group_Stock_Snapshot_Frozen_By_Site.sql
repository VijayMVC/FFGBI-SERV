...
-- Description:	Frozen snapshot by site
-- =============================================
CREATE PROCEDURE [dbo].[Group_Stock_Snapshot_Frozen_By_Site] 
...
WHERE    
mat1.storageType = 2 and pr.InventoryTypeID in (1,3) and not(pr.description1 like '%FRESH%') and  
