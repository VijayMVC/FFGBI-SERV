...
-- =============================================
--exec [dbo].[HR_AllocateStockToOrder] '99343','1'
CREATE PROCEDURE [dbo].[HR_AllocateStockToOrder_Backup] 
...
WHERE  
HR.Group_Order_no = @OrderNo and Hr.Sub_Order_no =  @OrderSubNo and
mat1.storageType = 1 
