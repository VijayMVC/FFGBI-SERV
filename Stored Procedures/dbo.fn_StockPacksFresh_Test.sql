...
-- =============================================#
--exec  dbo.fn_StockPacksFresh_Test 'and pk.Siteid' 
CREATE procedure [dbo].[fn_StockPacksFresh_Test]
...
SELECT     pk.OrgSite,os.orgsitename,sscc,
pk.DeviceID, 
...
WHERE  mat1.storageType = 1 and pr.InventoryTypeID = 1 and not(pr.description1 like ''%FROZEN%'') 
and pk.weight > 0.1 ' + @Where
exec(@SQL)
