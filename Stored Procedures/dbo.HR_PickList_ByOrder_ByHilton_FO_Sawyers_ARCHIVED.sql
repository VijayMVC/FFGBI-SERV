...
-- =============================================
--exec [dbo].[HR_PickList_ByOrder_ByHilton_FG_Sawyers]  999999
CREATE PROCEDURE [dbo].[HR_PickList_ByOrder_ByHilton_FO_Sawyers_ARCHIVED] 
@OrderNo Int
--@SiteID int
AS
BEGIN
...
From #tmp
where siteid = 'FO' and isnull(inventoryid,0) =105
Group By 
